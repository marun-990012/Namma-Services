...
import {
  fetchAddress,
  updateAddress,
} from "../../redux/slices/profileAddressSlice";
function ProfileUpdate() {
  ...
  const validations = () => {
    ...
    if (
      userAccount?.userType !== "work-provider" &&
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await Promise.all([
        ...
        dispatch(
          updateAddress({ street, city, state, postalCode, country })
        ).unwrap(),
      ]);
            ...
            <div className="flex gap-2">
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className="border border-gray-300 shadow rounded focus:outline-none focus:border-orange-200 px-[3px] py-[4px] text-center w-22"
                />
              </div>
            </div>
