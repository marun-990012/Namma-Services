    ...
    <div className="flex justify-center items-center border-3 border-white p-10 pt-4 rounded-[8px] mb-4">
      <div>
        ...
        <div className="flex justify-center items-center">
          <div className="flex w-[90%] justify-center mt-3">
            {/* Left Section */}
            <div className="rounded-xl shadow-md bg-white p-5 w-[50%] flex flex-col gap-2">
              <p className="text-[17px]">
                Title:{" "}
                <span className="text-gray-400">Electric fan repair</span>
              </p>
              <p className="text-[17px]">
                Description:{" "}
                <span className="text-gray-400">
                  We are seeking a skilled and certified Electrician to join our
                  team. The ideal candidate will be responsible for installing,
                  maintaining, and repairing electrical systems in residential,
            ...
            {/* Right Section */}
            <div className="w-65 mx-auto bg-white rounded-xl shadow-md overflow-hidden">
        ...
        {/* address div */}
        <div className="flex justify-center w-[77%] mt-7">
          <div className="bg-white w-[77%] px-6 shadow-md rounded-[8px] p-4 mr-23">
            <p>Work address</p>
            <p className="text-gray-500">Work address electrical systems in residential, commercial, and industrial settings</p>
          </div>
        </div>

        {/* requested users list */}
        <div className="flex justify-center w-[90%] mt-7">
          <div className="bg-white w-[90%] px-6 shadow-md rounded-[8px] p-4 ">
            <div className="bg-green-200 w-60 flex justify-between p-2 rounded">
                <button onClick={()=>{navigate(`/job/post/details/requests/${id}`)}} className={requested? "cursor-pointer bg-green-400 hover:bg-green-500 text-white py-1  w-27 rounded" : "cursor-pointer text-green-600 py-1  w-27 rounded"}>Requested</button>
                <button onClick={()=>{navigate(`/job/post/details/considers/${id}`)}} className={considered? "cursor-pointer bg-green-400 hover:bg-green-500 text-white py-1  w-27 rounded":"cursor-pointer text-green-600 py-1  w-27 rounded"}>Considered</button>
            </div>
