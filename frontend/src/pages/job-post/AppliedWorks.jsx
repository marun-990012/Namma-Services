...
function AppliedWorks() {
   ...
   const appliedJob = jobList.filter(job =>
  ...
  return (
    <div>
        <p className="text-lg font-semibold text-gray-800 ml-2 ">All recently applied works - <span>{appliedJob?.length}</span></p>
      {appliedJob?.map((job) => {
        return (
          <div className="flex justify-center w-full">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white w-[100%]  py-2 px-4 rounded-xl border border-gray-200 shadow-md mt-3 gap-3">
              ...
              {/* View Button */}
              <div className=" flex gap-6 items-center self-start md:self-center">
                <div>
                    <p className="bg-green-200 text-green-800 font- px-3 rounded-full">
